            ...
            <div class="mt-48 w-full md:w-3/4 text-center">
                ...
                <div class="mt-14 text-center md:text-right flex flex-col md:flex-row items-center justify-between">
                    <div class="w-full md:w-1/2 pb-8 md:pr-8">
                        <h2 class="font-wedding text-4xl text-semibold text-gray-800">Irna Nurmala</h2>
                        <a href="https://instagram.com/irnalaa_" target="blank" class="text-pink-500 underline underline-offset-2">
                            <font-awesome-icon icon="fa-brands fa-instagram" />
                            irnalaa_
                        </a>

                        <p class="text-sm mt-3 tracking-normal leading-relaxed text-center md:text-right text-gray-700">
                            Putri kedua dari Ayah Kirno dan Mamah Ade.
                        </p>
                    </div>
                ...
                <div class="mt-14 text-center md:text-left flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div class="w-full md:w-1/2 pb-8 md:pl-8">
                        <h2 class="font-wedding text-4xl text-semibold text-gray-800">Willy Rayadi</h2>
                        <a href="https://instagram.com/willray__" target="blank" class="text-pink-500 underline underline-offset-2">
                            <font-awesome-icon icon="fa-brands fa-instagram" />
                            willray__
                        </a>

                        <p class="text-sm mt-3 tracking-normal leading-relaxed text-center md:text-left text-gray-700">
                            Anak ketiga dari Ibu Sukinah.
                        </p>
                    </div>
...
Kisah ini berawal dari pertemuan kita diakhir taun 2021 tepatnya di tanggal 26 Desember, yang bermula dari pertemuan yang tidak sengaja.<br><br>

❤️Berkomitmen Bersama<br>

Kemudian setelah pertemuan itu komunikasi kita menjadi lebih intens dan sering menghabiskan waktu bersama, pada bulan Januari 2022 kita mulai berkomitmen untuk masa depan hubungan kita.<br><br>
                        </p>
                    </div>
                    <div class="w-full md:w-2/4">
                ...
                <div class="mt-14 flex flex-col md:flex-row items-center justify-center">
                    ...
                    <div class="w-full md:w-2/4 text-gray-700">
                        ...
                        <p class="mt-5 leading-relaxed text-justify md:text-left pb-8 md:pl-8">
                            Pada tanggal 29 Mei 2022, Willy memberanikan diri datang bersama keluarga ke tempat kediaman Irna untuk melangsungkan acara Lamaran & Irna pun dengan senang hati menerima nya.
                        </p>
                    </div>
                ...
                <div class="mt-14 flex justify-center">
                    <div class="w-full text-gray-700">
                        ...
                        <p class="mt-5 leading-relaxed text-justify md:text-center pb-8 md:pl-8">
                            ...
                            dengan izin Allah SWT maka ditetapkanlah akad nikah kami pada tanggal yang belum ditentukan.
                        </p>
                    </div>
                </div>
            </div>
                            ...
                            <Transition name="fade-quick">
                                <div v-if="isRizky" key="1" class="w-full flex flex-col md:flex-row justify-between items-center mt-6">
                                    ...
                                    <div class="w-full md:w-1/2">
                                        ...
                                        <p class="text-sm">a/n Willy Rayadi</p>
                                    </div>
                                </div>
                                ...
                                <div v-else key="2" class="w-full flex flex-col md:flex-row justify-between items-center mt-6">
                                    ...
                                    <div class="w-full md:w-1/2">
                                        ...
                                        <p class="text-sm">a/n Irna Nurmala</p>
                                    </div>
                                </div>
                            </Transition>
                        </div>
        ...
        <div class="text-center bg-gray-800 p-8 flex flex-col items-center justify-center">
            <p class="text-gray-400 mb-5">2022 &copy; Built and Designed by Irna's <span class="text-pink-500"><font-awesome-icon icon="fa-solid fa-heart" /></span></p>
